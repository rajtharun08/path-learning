...
class ProgressController:
    ...
    def create_note(self, user_id: str, video_id: str, content: str, video_timestamp: int, title: str = None):
        return self.service.create_note(user_id, video_id, content, video_timestamp, title)
