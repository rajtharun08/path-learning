...
start "Content Service (8002)" cmd /k "D:\path-learning\venv\Scripts\activate && cd /d D:\path-learning\backend\youtube_service\services\content-service && uvicorn app.main:app --reload --port 8002"

:: 2. Start Progress Service (8003)
echo Starting Progress Service...
start "Progress Service (8003)" cmd /k "D:\path-learning\venv\Scripts\activate && cd /d D:\path-learning\backend\youtube_service\services\progress-service && uvicorn app.main:app --reload --port 8003"

:: 3. Start Analytics Service (8004)
echo Starting Analytics Service...
start "Analytics Service (8004)" cmd /k "D:\path-learning\venv\Scripts\activate && cd /d D:\path-learning\backend\youtube_service\services\analytics-service && uvicorn app.main:app --reload --port 8004"
